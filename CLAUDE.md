...
<插件>/                            # hongzhi-core + 8 业务插件
  ...
  agents/<名>.md                    # 监控代理（dispute-resolution/deadline-watcher、commercial-contract/playbook-monitor）
...
| commercial-contract | 7（三件套 + contract-drafting, contract-review, deal-debrief, review-proposals；代理 playbook-monitor） |
| dispute-resolution | 19（三件套 + deadline-tracker, element-analysis, portfolio-status, litigation-full-process, case-intake, case-analysis, case-chronology, civil-complaint-drafting, defense-statement, appeal-petition, agent-brief, judgment-analysis, retrial-analysis, litigation-visualization, lawyer-letter, settlement） |
